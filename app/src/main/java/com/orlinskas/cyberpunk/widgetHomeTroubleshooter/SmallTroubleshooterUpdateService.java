...
class SmallTroubleshooterUpdateService extends Service {
    private int myWidgetID;
    private Context context;

    public SmallTroubleshooterUpdateService() {
    }
    ...
    private void sendIntentToUpdate(int myWidgetID) {
        ...
        Intent update = new Intent(context, SmallTroubleshooterWidget.class);
        update.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetID);
        update.putExtra(TroubleshooterWidget.ACTION, SmallTroubleshooterWidget.ACTION_UPDATE);
