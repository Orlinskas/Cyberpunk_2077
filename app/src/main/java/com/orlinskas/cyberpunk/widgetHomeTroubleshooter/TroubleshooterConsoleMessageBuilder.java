...
public class TroubleshooterConsoleMessageBuilder {
    private Forecast forecast;
    private Context context;

    TroubleshooterConsoleMessageBuilder(Forecast forecast, Context context) {
        this.forecast = forecast;
        this.context = context;
    }

    String buildLastUpdate() {
