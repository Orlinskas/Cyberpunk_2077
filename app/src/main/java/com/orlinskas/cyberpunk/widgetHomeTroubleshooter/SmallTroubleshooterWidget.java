...
public class SmallTroubleshooterWidget extends AppWidgetProvider {
        ...
        if(appWidgetID != AppWidgetManager.INVALID_APPWIDGET_ID) {
            ...
            switch (actionExtra) {
                ...
                case ACTION_CLICK_UPDATE_BUTTON:
                    SmallTroubleshooterWidget.UpdateWidgetTask task = new SmallTroubleshooterWidget.UpdateWidgetTask(context, appWidgetID);
                    task.execute();
                    break;
    ...
    public void createWidget(int appWidgetID, Context context) {
        RemoteViews widgetView = new RemoteViews(context.getPackageName(), R.layout.widget_troubleshooter_small);

        Intent updateClickIntent = new Intent(context, SmallTroubleshooterWidget.class);
        ...
        Intent flashLightClickIntent = new Intent(context, SmallTroubleshooterWidget.class);
        ...
        Intent wifiClickIntent = new Intent(context, SmallTroubleshooterWidget.class);
        ...
        Intent openWeatherPageIntent = new Intent(context, SmallTroubleshooterWidget.class);
        ...
        widgetView.setOnClickPendingIntent(R.id.widget_troubleshooter_small_im_update_btn, pUpdateIntent);
        widgetView.setOnClickPendingIntent(R.id.widget_troubleshooter_small_iv_flashlight, pFlashlightIntent);
        widgetView.setOnClickPendingIntent(R.id.widget_troubleshooter_small_iv_wifi, pWifiIntent);
        widgetView.setOnClickPendingIntent(R.id.widget_troubleshooter_small_rl_clock, pWeatherPageIntent);
        widgetView.setOnClickPendingIntent(R.id.widget_troubleshooter_small_ll_troubleshooter, pWeatherPageIntent);

        widgetView.setImageViewResource(R.id.widget_troubleshooter_small_im_update_btn, R.drawable.im_update_btn_off);
        widgetView.setImageViewResource(R.id.widget_troubleshooter_small_iv_troubleshooter, R.drawable.im_trouble_text_2);
        widgetView.setImageViewResource(R.id.widget_troubleshooter_small_iv_percipitation, R.drawable.im_percipitation_off);
        widgetView.setImageViewResource(R.id.widget_troubleshooter_small_iv_wind, R.drawable.im_wind_off);
        widgetView.setImageViewResource(R.id.widget_troubleshooter_small_iv_wet, R.drawable.im_wet_off);
        widgetView.setImageViewResource(R.id.widget_troubleshooter_small_iv_head, R.drawable.im_head_off);
        widgetView.setImageViewResource(R.id.widget_troubleshooter_small_iv_flashlight, R.drawable.im_btn_flashlight_off);

        if(isWifiEnabled(context)) {
            widgetView.setImageViewResource(R.id.widget_troubleshooter_small_iv_wifi, R.drawable.im_btn_wifi_on);
        }
        else {
            widgetView.setImageViewResource(R.id.widget_troubleshooter_small_iv_wifi, R.drawable.im_btn_wifi_off);
        }

        widgetView.setViewVisibility(R.id.widget_troubleshooter_small_pb, View.INVISIBLE);
    ...
    private void updateUI(int appWidgetID, Forecast forecast, Context context) {
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_troubleshooter_small);

        updateMain(views, forecast);
    ...
    private void updateMain(RemoteViews views, Forecast forecast) {
        TroubleshooterDataBuilder builder = new TroubleshooterDataBuilder();
        ...
        views.setTextViewText(R.id.widget_troubleshooter_small_tv_city_name, cityName);
        views.setImageViewResource(R.id.widget_troubleshooter_small_iv_weather_icon, ID);
        views.setTextViewText(R.id.widget_troubleshooter_small_tv_weather_value, temperature);
    }

    private void updateTroubleshooter(RemoteViews views, Forecast forecast) {
        TroubleshooterIconSelector troubleShooter = new TroubleshooterIconSelector(forecast);

        if(troubleShooter.shootPrecipitation()) {
            views.setImageViewResource(R.id.widget_troubleshooter_small_iv_percipitation, R.drawable.im_percipitation_on);
        }
        if(troubleShooter.shootWind()) {
            views.setImageViewResource(R.id.widget_troubleshooter_small_iv_wind,R.drawable.im_wind_on);
        }
        if(troubleShooter.shootWet()) {
            views.setImageViewResource(R.id.widget_troubleshooter_small_iv_wet, R.drawable.im_wet_on);
        }
        if (troubleShooter.shootHeadPain()) {
            views.setImageViewResource(R.id.widget_troubleshooter_small_iv_head, R.drawable.im_head_on);
        }
    ...
    private class UpdateWidgetTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            widgetView = new RemoteViews(context.getPackageName(), R.layout.widget_troubleshooter_small);
            widgetView.setViewVisibility(R.id.widget_troubleshooter_small_pb, View.VISIBLE);
            widgetView.setImageViewResource(R.id.widget_troubleshooter_small_im_update_btn, R.drawable.im_update_btn_on);
            AppWidgetManager.getInstance(context).updateAppWidget(appWidgetID, widgetView);
        }
