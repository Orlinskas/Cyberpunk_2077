...
public class SmallWeatherWidget extends AppWidgetProvider {
    ...
    public void updateWidget(int appWidgetID, Context context) {
        ...
        Intent leftClickIntent = new Intent(context, SmallWeatherWidget.class);
        ...
        Intent rightClickIntent = new Intent(context, SmallWeatherWidget.class);
        ...
        Intent centerClickIntent = new Intent(context, SmallWeatherWidget.class);
